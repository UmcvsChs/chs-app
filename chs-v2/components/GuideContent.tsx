...
export default function GuideContent() {
  return (
    <div className="text-sm text-gray-600 leading-relaxed space-y-2">
      ...
      <h3 className="text-sm font-bold text-chs-charcoal mt-3 mb-1">3.6 Held funds from a property sale</h3>
      <p>If you sell a property, your real net proceeds appear in your wallet the moment the buyer pays — but as a held balance you can see, not yet withdraw. This is a genuine protection for the buyer: your funds only move into your spendable Main Wallet once CHS confirms the real, physical legal documents (Deed of Assignment, Certificate of Occupancy, and everything else required) have genuinely been transferred to them. There&apos;s nothing further for you to do to trigger this — CHS coordinates the real handover and releases the funds once it&apos;s confirmed complete.</p>
      ...
      <h3 className="text-sm font-bold text-chs-charcoal mt-3 mb-1">4.4 Once your offer is accepted — paying for a property</h3>
      <p>When the owner accepts your offer, you&apos;ll see a real, transparent breakdown before paying anything: the accepted price, your commission (shown as both the percentage and the real Naira amount), and the combined total due — charged in one single payment, never as two separate charges. The seller likewise sees, in advance, the real net amount they&apos;ll receive after their own commission.</p>
      <p>Payment can only go through once CHS has verified every real legal document required for that property — Certificate of Occupancy, Deed of Assignment, Survey Plan, Governor&apos;s Consent, Tax Clearance Certificate, Sale Agreement, and Building Plan Approval where a real structure exists. If verification is still in progress, you&apos;ll see this clearly instead of a payment button, and you&apos;ll be notified the moment it&apos;s ready.</p>
      <p>Once you pay, the seller&apos;s proceeds are held — visible to them, but not withdrawable — until CHS confirms the real, physical legal documents have genuinely been transferred to you. This protects you as the buyer: the seller cannot access the money until you have real, complete legal ownership.</p>
      ...
      <h3 className="text-sm font-bold text-chs-charcoal mt-3 mb-1">4.10 Once you&apos;re a tenant — your rent countdown and non-renewal notice</h3>
      <p>Once you move into a real tenancy, your dashboard shows a real, live day-count to your next rent due date — updated daily, not just a plain date range. If you don&apos;t plan to renew, please give notice at least 90 real days before your lease ends; your dashboard highlights this window as it approaches, with a real button to notify your landlord. Notice given later than 90 days is still recorded and sent, honestly noted as later than requested rather than refused.</p>
      ...
      <h3 className="text-sm font-bold text-chs-charcoal mt-3 mb-1">5.2a Legal documents required to list a Sale property</h3>
      <p>Listing a property under Sale requires uploading real soft copies of the legal documents needed to genuinely transfer ownership under Nigerian law: Certificate of Occupancy, Deed of Assignment, Survey Plan, Governor&apos;s Consent, Tax Clearance Certificate, and Sale Agreement — plus Building Plan Approval if the property has a real structure on it (not required for raw land). CHS verifies each document independently. A buyer&apos;s payment cannot proceed until every required document for your property is confirmed verified.</p>
      <h3 className="text-sm font-bold text-chs-charcoal mt-3 mb-1">5.2b When a buyer&apos;s offer is accepted</h3>
      <p>Tap &quot;Offer Accepted — Proceed to Payment&quot; to accept a real offer — this is the actual next step for the buyer, not just a status change. You can also decline with an optional message, which the buyer receives directly. Once the buyer pays, your real proceeds appear in your wallet, held until CHS confirms the physical legal documents have genuinely been transferred to the buyer — see &quot;Your CHS Wallet&quot; above for how this hold works.</p>
