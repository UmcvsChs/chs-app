-- Real fix: marking a vendor referral fee as "paid" only ever flipped
-- a status — the vendor was never actually charged the real fee they
-- owe CHS for a deal connected through the platform.
