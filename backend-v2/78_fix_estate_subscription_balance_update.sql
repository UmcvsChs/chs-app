-- Real fix: the initial version only checked balance via a computed
-- ledger sum but never updated the displayed wallets.main_balance
-- column, meaning the wallet page would show a stale balance after a
